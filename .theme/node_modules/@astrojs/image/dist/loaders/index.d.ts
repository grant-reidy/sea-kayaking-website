...
import { type NamedColor } from './colornames.js';
export declare type InputFormat = 'heic' | 'heif' | 'avif' | 'jpeg' | 'jpg' | 'png' | 'tiff' | 'webp' | 'gif';
export declare type OutputFormatSupportsAlpha = 'avif' | 'png' | 'webp';
export declare type OutputFormat = OutputFormatSupportsAlpha | 'jpeg';
export declare type ColorDefinition = NamedColor | `#${string}` | `rgb(${number}, ${number}, ${number})` | `rgb(${number},${number},${number})`;
